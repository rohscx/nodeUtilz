...
module.exports = function (arrayIp,url,auth,opts) {
  ...
  const ipChecker = (data,index) => {
    if (data.search(/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/) === 0) {
      return true;
    } else {
      ...
      const options = { method: 'GET',
        ...
        headers: 
          { 'cache-control': 'no-cache',
            ...
            Cookie: 'JSESSIONID=DBC7E64581B9AB0BFFA02657D20A88AD; JSESSIONID=9DB6D7D9D54A646D7DA30313963F318A',
            Host: url,
            'Cache-Control': 'no-cache',
            Accept: '*/*',
