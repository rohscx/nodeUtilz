...
module.exports = async function getPrimeDevices(urlString,uriString,fString,mString) {
  const result = await primeApi.requestAsyncPrimeData(urlString,uriString,fString,mString)
  // debug
